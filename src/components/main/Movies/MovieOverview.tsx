      ...
      <ModalVideo
        ...
        playlist={
          !movie
            ...
            ? movie.videos.results.map((video) => video.key)
            : null
        }
        videoId={
          !movie
                ...
                {movie && movie.genres.length >= 1 && (
                  <i className="mt-0 text-subtle">
                    {movie.genres.map((genre, index) => (
                      <Link
                        className="view__genre"
                        key={`${movie.id}_genre${genre.id}`}
                    ...
                    <>
                      ...
                      <button
                        ...
                        style={{
                          ...
                          background: isFavorite(movie.id)
                            ? "#ff2e4f"
                            : "transparent",
                          border: isFavorite(movie.id)
                            ? "1px solid #ff2e4f"
                            : `1px solid ${getCSSVar("--text-color")}`,
                        }}
                      >
